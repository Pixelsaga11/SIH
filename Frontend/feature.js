const views = {
  trains: {
    ...
    cards: [
      ...
      '<article class="feature-card"><h2>Train availability</h2><p>Availability and predicted timing for matching services</p><ul class="feature-list searchable-trains" id="searchableTrains"><li data-route="rajdhani" data-search="12952 rajdhani express"><span><button class="train-name" type="button">12952 Rajdhani Express</button><small>New Delhi → Mumbai Central · Departs 14:00</small></span><b><em class="availability available">Available</em>19:04</b></li><li data-route="shatabdi" data-search="12045 shatabdi express"><span><button class="train-name" type="button">12045 Shatabdi Express</button><small>New Delhi → Chandigarh · Departs 06:00</small></span><b><em class="availability available">Available</em>18:42</b></li><li data-route="duronto" data-search="12220 duronto express"><span><button class="train-name" type="button">12220 Duronto Express</button><small>Pune → Mumbai · Departs 22:30</small></span><b><em class="availability limited">Limited</em>19:26</b></li><li data-route="garib" data-search="12910 garib rath"><span><button class="train-name" type="button">12910 Garib Rath</button><small>Jaipur → New Delhi · Departs 16:10</small></span><b><em class="availability available">Available</em>19:18</b></li><li data-route="tejas" data-search="82902 tejas express"><span><button class="train-name" type="button">82902 Tejas Express</button><small>Ahmedabad → Mumbai · Departs 15:40</small></span><b><em class="availability unavailable">Unavailable</em>20:02</b></li></ul><p class="no-search-results" id="noSearchResults" hidden>No matching train found. Try a train name or number.</p></article>'
    ]
  },
  network: {
    title: "Network view",
...
if (key === "trains") {
  ...
  trainItems.forEach((item) => item.querySelector(".train-name").addEventListener("click", () => {
    window.location.href = `index.html?route=${item.dataset.route}`;
  }));
}
